...
//               (d[h].proportions = {width: d[h].element[0].offsetWidth, height: d[h].element[0].offsetHeight});
//           }
//         },
//         drop: function (b, c) {
//           var d = !1;
...
//         var c =
//             this.options.axis === "x" || a.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, b.top, b.height),
//           d =
//             this.options.axis === "y" ||
//             a.ui.isOverAxis(this.positionAbs.left + this.offset.click.left, b.left, b.width),
//           e = c && d,
...
//             Math.abs(j - h) < f &&
//               ((f = Math.abs(j - h)), (g = this.items[i]), (this.direction = j - h > 0 ? "down" : "up"));
//           }
...
//               ? ((c = b.parent().replaceWith(b)), (b[0] === d || a.contains(b[0], d)) && a(d).focus(), c)
//               : b;
//           },
...
//         c.prev().attr({"aria-expanded": "false", "aria-selected": "false", tabIndex: -1}).blur(),
